    ...
    <div class="english-description">
      <ul class="coupon-list">
        <li class="coupon-item">
          <a href="https://example.com/" class="coupon-description">¥10 新用户优惠券</a>
        </li>
        <li class="coupon-item">
          <a href="https://example.com/" class="coupon-description">满¥199减¥20活动券</a>
        </li>
        <li class="coupon-item">
          <a href="https://example.com/" class="coupon-description">618活动专享券</a>
        </li>
        <li class="coupon-item">
          <a href="https://example.com/" class="coupon-description">品牌旗舰店满减券</a>
        </li>
      </ul>
    </div>
  </div>
